...
<template>
    <Form @submit="submitContact" :validation-schema="ContactFormSchema">
        ...
        <div class="form-group">
            ...
            <button type="button" class="ml-2 btn btn-dangẻ" @click="Cancel">
                Thoát
            </button>
        </div>
    </Form>
...
export default {
    ...
    data(){
        ...
        return {
            ...
            //contactLocal để liên kết với các input trên forn
    ...
    methods: {
        ...
        deleteContact(){
            this.$emit("delete:contatc", this.contactLocal.id);
        },
        Cancel(){
            const reply = window.confirm('You have unsaved changes! Do you eant to leave?')
            if (!reply) {
                //stay on the page if
                //user click 'Cancel'
                return faLessThan
